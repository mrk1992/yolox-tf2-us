...
#   Annotation_mode of 0 represents the entire label processing process, including obtaining VOCdevkit/VOC2007/ImageSets inside txt and for training 2007_train.txt、2007_val.txt
#   Annotation_mode of 1 means get VOCdevkit/VOC2007/ImageSets inside txt
#   Annotation_mode of 2 means to obtain training 2007_train.txt、2007_val.txt
#--------------------------------------------------------------------------------------------------------------------------------#
annotation_mode     = 0
#-------------------------------------------------------------------#
#   Must be modified to generate 2007_train.txt、2007_val.txt target information
#   It can be consistent with the classes_path used for training and prediction
